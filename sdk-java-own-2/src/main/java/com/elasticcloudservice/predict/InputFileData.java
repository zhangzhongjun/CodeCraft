...
public class InputFileData {
    ...
    public InputFileData(String[] lines) throws ParseException {
        ...
        this.firstDate = sdf.parse(lines[i].split(" ")[0]);
        i = i+1;
        this.lastDate = sdf.parse(lines[i].split(" ")[0]);
    }
    ...
    public int getKuaDuOfDay(){
        return DateUtils.diffOfDay(this.lastDate,this.firstDate);
    }
}
